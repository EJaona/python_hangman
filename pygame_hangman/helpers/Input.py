...
class Input:
    ...
    def __init__(self, position_x, position_y, width, height) -> None:
        ...
        self.input_box:pygame.Rect = display_helpers.create_input_box(position_x, position_y, width, height)
    ...
    def get_text(self, display_text) -> str:
        ...
        while self.collect_input:
            ...
            display_helpers.draw_shape_to_screen(self.input_box, self.border_color)
